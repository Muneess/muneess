...
/* Austin_GB #:3117, WH Lee, 20110610 */
//#define CONFIG_CUSTOM_WPS 1
/* WH Lee, 20110610 */

#ifdef CONFIG_CUSTOM_WPS
int wps_flag; //bear
#endif /* CONFIG_CUSTOM_WPS */
...
//bear
#ifdef CONFIG_CUSTOM_WPS 
static char * wps_ie_txt(char *pos, char *end,
		         const struct wpa_scan_res *res)
{
	int ret;
	const char *txt = "[CUSTOM_WPS]";
